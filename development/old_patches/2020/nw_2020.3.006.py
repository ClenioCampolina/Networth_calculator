...
print('Crypto Net Worth 2020.3.006\n')
#Now supported:
...
addcgnames = False                  #Only ran this code once to add all names fo coins from 
if addcgnames:
    ...
    for x in range(len(cg_js)):
        ...
        # elif id == 'uniswap':
        #     cur.execute('''INSERT OR IGNORE INTO Names_database (coingecko,blockchair) VALUES (?,?)''',(id,'uniswap'))
        else:
    ...
    for items in range(len(tokenlist)):
        ...
        if (tokenname,) not in coingeckolst:
            ...
            try:
                ...
                print('The token name {} is not in the column blockchair of the Names_database table.'.format(original))
