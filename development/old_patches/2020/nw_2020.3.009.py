...
print('Crypto Net Worth 2021.0.002\n')
#Now supported:
    ...
    #       Do not print coins that has a balance of zero (or a chosen minimum)
    #       Get a new list of all coins supported by coingecko
...
#_______________________________________Ask if user wants to update Coin

#The default value for addcgnames is False. We should only turn addcgnames True once, to add all names of coins from coingecko website and the exceptions for blockchair to the database. This works as consultation list for mismatch names between Coingecko and Blockchair.
...
eth_bal = float(84.42) #check on Zapper
...
for currency in currencylist:
    ...
    for (v,k) in coinsdict.items():
        if v == 'alchemix-usd':    #Coingecko has some issue with alchemix-usd. It doesn't have any data yet. Once they fix it, we can remove this.
            continue
